    ...
    <main className="min-h-screen">
      ...
      <section className="py-14 bg-gradient-to-b from-black to-blue-950 text-center px-4 sm:px-8 md:px-16 lg:px-32">
        ...
        <form className="flex flex-col sm:flex-row sm:flex-wrap justify-center items-center gap-4 pt-6">
          ...
          />
          <button className="bg-green-600 p-3 text-white rounded w-full sm:w-auto">
            <Link href="./Routes/UsedCars">
              ...
              >
                <path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5..."></path>
              </svg>
            </Link>
          </button>
        </form>
      ...
      <section className="mt-16 px-4 sm:px-8 md:px-16 lg:px-32">
        ...
        <div className="flex flex-col sm:flex-row justify-between mt-6 gap-6">
          ...
          {/* Sell It For Me */}
          <div className="flex-1 py-10 border-gray-200 px-5">
      ...
      {/* Featured New Cars */}
      <section className="pt-10 bg-gray-200 px-4 sm:px-8 md:px-16 lg:px-32">
